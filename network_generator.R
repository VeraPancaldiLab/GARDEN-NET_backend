...
args <- parser_arguments(args = c("--PCHiC", "./input_datasets/Homo_sapiens-aCD4.tsv", "--chromosome", "1", "--range2ENSG_database", "../GARDEN-NET_utils_related/Homo_sapiens-range2ensembl.tsv"))
